...
| 11 | Apple Developer account | **MauriceAK account** (2026-09-18 takeover) — Team ID `XXXXXXXXXX` (pending enrollment processing); bundle ID `com.mauriceak.semreh`; SKU `semreh-ios` |
